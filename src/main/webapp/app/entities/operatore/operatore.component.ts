...
export class OperatoreComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.operatoreService
            ...
            .subscribe(
                (res: HttpResponse<IOperatore[]>) => this.paginateOperatores(res.body, res.headers),
    ...
    private paginateOperatores(data: IOperatore[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.queryCount = this.totalItems;
        this.operatores = data;
    }
