...
export class IstitutoComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.istitutoService
            ...
            .subscribe(
                (res: HttpResponse<IIstituto[]>) => this.paginateIstitutos(res.body, res.headers),
    ...
    ngOnInit() {
        ...
        this.registerChangeInIstitutos();
    }
    ...
    trackId(index: number, item: IIstituto) {
        return item.id;
    }
