...
@Component({
    selector: 'jhi-storico-telefono',
    templateUrl: './storico-telefono.component.html'
})
export class StoricoTelefonoComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/storico-telefono'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
