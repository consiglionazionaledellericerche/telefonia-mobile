...
import { ServiziComponent } from 'app/entities/servizi/servizi.component';
import { ServiziService } from 'app/entities/servizi/servizi.service';
import { Servizi } from 'app/shared/model/servizi.model';

describe('Component Tests', () => {
    describe('Servizi Management Component', () => {
        let comp: ServiziComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ServiziComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.servizis[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
