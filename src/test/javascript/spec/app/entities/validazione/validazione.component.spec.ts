...
import { ValidazioneComponent } from 'app/entities/validazione/validazione.component';
...
describe('Component Tests', () => {
    describe('Validazione Management Component', () => {
        let comp: ValidazioneComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ValidazioneComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.validaziones[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
