...
import { UtenzaComponent } from 'app/entities/utenza/utenza.component';
import { UtenzaService } from 'app/entities/utenza/utenza.service';
import { Utenza } from 'app/shared/model/utenza.model';

describe('Component Tests', () => {
    describe('Utenza Management Component', () => {
        let comp: UtenzaComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(UtenzaComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.utenzas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
