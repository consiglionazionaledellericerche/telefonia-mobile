...
public class ValidazioneResourceIntTest {
    ...
    public void setup() {
        ...
        final ValidazioneResource validazioneResource = new ValidazioneResource(validazioneRepository, telefonoService);
    ...
    public void getAllValidaziones() throws Exception {
        ...
        restValidazioneMockMvc.perform(get("/api/validaziones?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].dataValidazione").value(Matchers.hasItem(TestUtil.sameInstant(DEFAULT_DATA_VALIDAZIONE))))
    ...
    public void getValidazione() throws Exception {
        ...
        restValidazioneMockMvc.perform(get("/api/validaziones/{id}", validazione.getId()))
            ...
            .andExpect(jsonPath("$.dataValidazione").value(TestUtil.sameInstant(DEFAULT_DATA_VALIDAZIONE)))
    ...
    public void updateValidazione() throws Exception {
        ...
        assertThat(testValidazione.getUserDirettore()).isEqualTo(DomainUserDetailsServiceIntTest.ACE_USER_ADMIN);
